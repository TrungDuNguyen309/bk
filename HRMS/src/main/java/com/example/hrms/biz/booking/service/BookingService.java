        ...
        try {
            ...
            switch (req.getBookingType().toUpperCase()) {
                case "ONLY":
                    ...
                    booking.setStartTime(DateUtils.formatDateTime(today));
                    booking.setEndTime(DateUtils.formatDateTime(today));
                ...
                case "DAILY":
                    ...
                    for (int i = 0; i < daysBetween; i++) {
                        ...
                        dailyBooking.setStartTime(DateUtils.formatDateTime(startTimeToday));
                        dailyBooking.setEndTime(DateUtils.formatDateTime(endTimeToday));
                    ...
                    while (!current.isAfter(endDateTime)) {
                        for (String day : weekdays) {
                            ...
                            if (startTimeToday != null && !startTimeToday.isBefore(startDateTime) && !startTimeToday.isAfter(endDateTime)) {
                                ...
                                weeklyBooking.setStartTime(DateUtils.formatDateTime(startTimeToday));
                                weeklyBooking.setEndTime(DateUtils.formatDateTime(endTimeToday));
