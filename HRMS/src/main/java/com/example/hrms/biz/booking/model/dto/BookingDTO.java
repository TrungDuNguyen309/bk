...
public class BookingDTO {
    ...
    public static class Req {
        ...
        public static Req fromBooking(Booking booking) {
            ...
            req.setStartTime(booking.getStartTime() != null ? String.format(String.valueOf(formatter)) : null);
            req.setEndTime(booking.getEndTime() != null ? String.format(String.valueOf(formatter)) : null);
        ...
        public Booking toBooking() {
            ...
            booking.setStartTime(this.startDate != null && this.startTime != null
                    ? DateUtils.formatDateTime(DateUtils.parseDateTime(this.startDate + " " + this.startTime))
                    : null);
            booking.setEndTime(this.endDate != null && this.endTime != null
                    ? DateUtils.formatDateTime(DateUtils.parseDateTime(this.endDate + " " + this.endTime))
                    : null);
    ...
    public static class Resp {
        ...
        public static Resp toResponse(Booking booking) {
            ...
            DateTimeFormatter formatter = DateUtils.getDateTimeFormatter();
            resp.setStartTime(booking.getStartTime() != null ? String.format(String.valueOf(formatter)) : null);
            resp.setEndTime(booking.getEndTime() != null ? String.format(String.valueOf(formatter)) : null);
